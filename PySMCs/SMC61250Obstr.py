...
##  Import relevant modules and functions
    ...
    from global50km import global50km
...
#    4096    3072    0.043950  -89.970703   8.789062E-02   5.859375E-02
    obstrfile = Wrkdir+"Bathys/Glob6kmObstr.dat"
    print (" Read "+obstrfile+" ..." )
    hdr, obstrin = readtext(obstrfile, skiprows=[0,1])
    NCobs = int( hdr[0] )
    NRobs = int( hdr[1] )
    FLonb = float( hdr[2] )
    FLatb = float( hdr[3] )
...
#;; The obstruction will be equal in both x and y direction.
    Obstrout = Wrkdir+"tmpfls/SMC61250Obst.dat"
